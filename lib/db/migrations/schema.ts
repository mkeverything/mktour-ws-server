import { sqliteTable, AnySQLiteColumn, uniqueIndex, text, integer, foreignKey, real } from "drizzle-orm/sqlite-core"
...
export const club = sqliteTable("club", {
	...
	allowPlayersSetResults: integer("allow_players_set_results").default(true).notNull(),
},
(table) => [
